...
export const CleaningIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M3 21h18M9 8h6M12 3v5M5 21V8a2 2 0 012-2h10a2 2 0 012 2v13" />
  </svg>
);

export const PlumbingIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M6 3v3M18 3v3M6 9v12M18 9v12M6 9h12M9 9v3a3 3 0 006 0V9" />
  </svg>
);
...
export const GardeningIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M12 22V8M5 12H2a10 10 0 0020 0h-3M9 3l3 5 3-5" />
    <circle cx="12" cy="8" r="3" />
  </svg>
);

export const PaintingIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M19 3H5a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2zM12 11v9M8 21h8" />
  </svg>
);

export const MovingIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
